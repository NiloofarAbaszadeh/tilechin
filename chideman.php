...
<head>
    ...
    <title>tilery.ir :: کاشی‌کاری حرفه‌ای</title>
...
<script>
    if("<?php echo $_SESSION['login_user']; ?>" == "admin") {
        ...
        $(document).ready(function () {
            $("#backlink").attr("href", "adminpage.php");
        ...
        $(document).ready(function () {
            $("#backlink").attr("href", "userpage.php");
...
<div class="v-page-container v-hide">
    ...
    <canvas class="v-outlines-canvas" onClick="void(0);">
        <p>مرورگر شما از کانواس پشتیبانی نمیکند</p>
    </canvas>

    <div class="v-header-container col-sm-12">
        <div class="col-sm-6" style="direction: ltr;margin-top: 5px;">
            <a class="btn btn-warning" href="logout.php" >خروج</a>
            <a class="btn btn-warning"  id="backlink" href="" >  بازگشت </a>
            خوش آمدید<?php if(isset($_SESSION['login_user'])){ echo $_SESSION['login_user'];} ?>کاربر
        </div>
        <div class="col-sm-6">
                        ...
                        <div class="row xxxxxv-top v-height-100">
                            ...
                            <div class="col-xs-10 v-height-100">
                                <div class="v-rooms-popup-container">
                                    ...
                                    <p class="v-rooms-popup-title-text">انتخاب اتاق</p>
                                    ...
                                    <div class="v-room-thumbnails-container" id="thumbnails-containe">
                                    ...
                                    <div class="v-tile-selection">
                                        ...
                                        <div class="v-tile-thumbnails-container">
                                            <div style="display:-webkit-inline-box; vertical-align: middle;">
                                                <button onclick="showform()" class="btn btn-primary"  style="display: block">جستجوی پیشرفته</button>
                                                <button onclick="resetfilter()" class="btn btn-primary"  id="resetfilter" style="display: none"> خالی کردن فیلتر </button></div>
                                            <h4 style="text-align: center"><b> انتخاب کاشی </b></h4>
                                            <div id="searchform" style="display: none" >
                                                <form >
                                                    <div class="inner-addon right-addon">
                                                        <input style="text-align: right" type="text"index class="form-control" name="saerch[0]" id="searchname" placeholder="جستجو براساس نام محصول">
                                                    </div>
                                                    <br>
                                                    <div class ="responsive" >
                                                        <table class="table  col-sm-12 " id="t01">
                                                            <thead  >
                                                            <th style="text-align: right" class="col-sm-1">نوع</th>
                                                            <th style="text-align: right" class="col-sm-2">رنگ</th>
                                                            <th style="text-align: right" class="col-sm-2" >نوع لعاب </th>
                                                            <th style="text-align: right" class="col-sm-2" >مواد اولیه</th>
                                                            <th style="text-align: right" class="col-sm-2" > اندازه کاشی</th>
                                                            ...
                                                            <tr>
                                                                <td style="direction: rtl" class="col-sm-1">
                                                                    ...
                                                                    while ($row = $usagetile->fetch_assoc()) {
                                                                        ?>
                                                                        <input type="checkbox" name="saerch[type][]" value="<?php echo $row["name"]; ?>" id="type<?php echo  $row["id"]; ?>" ><?php echo  $row["persian_name"]; ?><br>
                                                                        <?php
                                                                    }
                                                                    ?>
                                                                ...
                                                                <td style="direction: rtl" class="col-sm-2">
                                                                    ...
                                                                    ?>
                                                                    <input type="checkbox" name="saerch[colour][]" value="<?php echo $row["name"]; ?>" id="color<?php echo  $row["id"]; ?>" ><?php echo  $row["persian_name"]; ?><br>
                                                                    <?php
                                                                    }
                                                                    ?>
                                                                </td>
                                                                <td style="direction: rtl" class="col-sm-2">
                                                                    ...
                                                                    while ($row = $finishtile->fetch_assoc()) {
                                                                        ?>
                                                                        <input type="checkbox" name="saerch[Finish][]" value="<?php echo $row["name"]; ?>" id="finish<?php echo  $row["id"]; ?>" ><?php echo  $row["persian_name"]; ?><br>
                                                                        <?php
                                                                    }
                                                                    ?>
                                                                </td>
                                                                <td style="direction: rtl" class="col-sm-2">
                                                                    ...
                                                                    while ($row = $materialtile->fetch_assoc()) {
                                                                        ?>
                                                                        <input type="checkbox" name="saerch[colour][]" value="<?php echo $row["name"]; ?>" id="mate<?php echo  $row["id"]; ?>" ><?php echo  $row["persian_name"]; ?><br>
                                                                        <?php
                                                                    }
                                                                    ?>
                                                                </td>
                                                                <td class="col-sm-4">
                                                                    ...
                                                                    while ($row = $sizetile->fetch_assoc()) {
                                                                        ...
                                                                        <label><input type="checkbox"
                                                                                      ...
                                                                                      id="size<?php echo $row["id"]; ?>" ><?php echo $row["name"]; ?></label>
...
<!--                                                                </td>-->
                                                    ...
                                                    <div style="text-align:-webkit-center">
                                                        <input name="submit" type="button" id="submit"  value="جستجو"  class="btn btn-primary">
                                                    </div>
                                                </form>
                                            </div>
                                            <hr/>
                                            <div class="products">
                                                <div style="text-align: center" >
                                                    <span> <button type="submit" name="nextsubmit" class="next btn-primary" id="nextsubmit" style="padding: 5px 5px 5px 5px; " disabled> بعدی </button>
                                                        صفحه<input id="startimage" style="border: none;width: 25px; text-align: center;background-color: ivory"   disabled> از <input  id="endimage" style="border: none; width: 25px;text-align: center;background-color: ivory" disabled>
                                                        <button type="submit" class="prev btn-primary" name="prevsubmit" id="prevsubmit" style="padding: 5px 5px 5px 5px; " disabled>قبلی</button>
                                                     </span>
                                                     <br/>
                                                     <br/>
                                                </div>
                        ...
                        <div class="row xxxxv-top v-height-100">
                            ...
                            <div class="col-xs-10 v-height-100">
                                <div class="v-paint-popup-container">
                                    ...
                                    <p class="v-paint-popup-title-text">انتخاب رنگ</p>
                        ...
                        <div class="row v-top">
                            ...
                            <div class="col-xs-10">
                                <div class="v-grout-popup-container">
                                    ...
                                    <p class="v-grout-popup-title-text">انتخاب رنگ برای بندکشی</p>
                        ...
                        <div class="row v-top">
                            ...
                            <div class="col-xs-6">
                                ...
                                <div class="v-share-popup-container">
                                    ...
                                    <p class="v-patterns-popup-title-text">به اشتراک گذاری ئ        </p>
                        ...
                        <div class="row v-top">
                            ...
                            <div class="col-xs-4">
                                ...
                                <div class="v-decorate-actions-popup-container">
                                    ...
                                    <p class="v-decorate-actions-popup-title-text">میخواهید چکار کنید؟</p>
...
<div class="v-message v-hide">ارسال پیام</div>
...
<script>
    ...
    function resetfilter() {
        ...
        $("#search-gallery").css('display' , 'none');
        var  sizelen = <?php echo $size_length;?>;
        var  matelen = <?php echo $material_length;?>;
        var  colourlen = <?php echo $colour_length;?>;
        var  finishlen = <?php echo $finish_length;?>;
        var  usagelen = <?php echo $usage_length;?>;
        ...
        for(var i=1; i<finishlen ; i++) {
            if(document.getElementById('finish'+i).checked ==true){
                document.getElementById('finish'+i).checked = false;
            }

        }
        for(var i=1; i<matelen ; i++) {
            if(document.getElementById('mate'+i).checked ==true){
                document.getElementById('mate'+i).checked = false;
            }
                    }
        for(var i=1; i<sizelen ; i++) {
            var ss = document.getElementById('size'+i);
            if(ss.checked == true){
                 ss.checked = false;
            }
        }
        // for(var i=1; i<11 ; i++) {
        //     if(document.getElementById('spfe'+i).checked ==true){
        //         document.getElementById('spfe'+i).checked = false;
        //     }
        //
        // }
        // for(var i=1; i<7 ; i++) {
        //     if(document.getElementById('thin'+i).checked ==true){
