...
<div class="container col-sm-12">
    <div style="float: left;">
        <form action="adminpage.php">
            <input type="submit" value="بازگشت" class="backbtn " style="border-radius: 5px 5px 5px 5px;"/>
        </form>
    </div>
</div>
<br/>
...
<div id="succ" style="display: none">
    <h5> اضافه کردن با موفقیت انجام شد</h5>
</div>
<div id="fail" style="display: none">
    <h5> حذف کردن با موفقیت انجام شد</h5>
</div>
<div class="container welld">
    <div class="col-sm-6">
        <h3 style="text-align: right">ویرایش ابعاد</h3>
        <hr>
        <div style="direction: rtl">
            <button onclick="add_new_size()" class="btn">اضافه کردن مورد جدید</button>
            <button onclick="delet_size()" class="btn">حذف ایتم های موجود</button>
        </div>
        <div id="addsize" style="display: none; direction: rtl;">
            <form  method="post">
                ...
                ?>
                <br/>
                <button type="submit" class="btn-warning" style="margin-top: 5px">اضافه</button>
            </form>
        </div>
        <div id="deletesize" style="display: none; direction: rtl; float: right;">
            <form  method="post" style="display: inline;">
                ...
                <button type="submit" class="btn-warning" style="margin-top: 5px">حذف</button>
                <?php
...
<div class="col-sm-6">
        <h3 style="text-align: right">ویرایش مواد اولیه</h3>
        <hr>
        <div style="direction: rtl">
            <button onclick="add_new_material()" class="btn">اضافه کردن مورد جدید</button>
            <button onclick="delet_material()" class="btn">حذف ایتم های موجود</button>
        </div>
    ...
    <div class="col-sm-6">
        <h3 style="text-align: right">ویرایش برند محصول</h3>
        <div style="direction: rtl">
            <button onclick="add_new_brand()" class="btn">اضافه کردن مورد جدید</button>
            <button onclick="delet_brand()" class="btn">حذف ایتم های موجود</button>
        </div>
    ...
    <div class="col-sm-6">
        <h3 style="text-align: right">ویرایش رنگ</h3>
        <hr>
        <div style="direction: rtl">
            <button onclick="add_new_colour()" class="btn">اضافه کردن مورد جدید</button>
            <button onclick="delet_colour()" class="btn">حذف ایتم های موجود</button>
        </div>
    ...
    <div class="col-sm-6">
        <h3 style="text-align: right">ویرایش لعاب </h3>
        <hr>
        <div style="direction: rtl">
            <button onclick="add_new_finish()" class="btn">اضافه کردن مورد جدید</button>
            <button onclick="delet_finish()" class="btn">حذف ایتم های موجود</button>
        </div>
    ...
    <div class="col-sm-6">
        <h3 style="text-align: right">ویرایش قسمت کاربرد</h3>
        <hr>
        <div style="direction: rtl">
            <button onclick="add_new_usage()" class="btn">اضافه کردن مورد جدید</button>
            <button onclick="delet_usage()" class="btn">حذف ایتم های موجود</button>
        </div>
