...
if (!$conn) {
    die("عدم برقراری با سرور: " . mysqli_connect_error());
}
?>
<?php
...
<div class="container col-sm-12">
    <div style="float: left;">
        <form action="adminpage.php">
            <input type="submit" value="بازگشت" class="backbtn " style="padding: 5px 25px 5px 25px;border-radius: 5px 5px 5px 5px;"/>
        </form>
    </div>
</div>
<br/>
...
<div style="text-align: center" >
   <span> <button type="submit" name="nextsubmit" class="next btn-primary" id="nextsubmit" style="padding: 5px 5px 5px 5px;border-radius: 5px 5px 5px 5px; " disabled> بعدی </button>
        ...
        <button type="submit" class="prev btn-primary" name="prevsubmit" id="prevsubmit" style="padding: 5px 5px 5px 5px; border-radius: 5px 5px 5px 5px;" disabled>قبلی</button>
    </span>
    <br/>
    <br/>
</div>
            ...
            <div class="col-xs-2">
                <div class="v-tile-thumbnail-container ">
                    ...
                    <div class="vs-p-name">
                        ...
                        <br/>
                        <button onclick="showmodal(<?php echo $I-1;?>)" style="width:auto; padding: 2px 5px 2px 5px; border-radius: 5px 5px 5px 5px;" class="edite" >ویرایش </button>
                        <button onclick="showmodaldelete(<?php echo $I-1;?>)" style="width:auto; padding: 2px 10px 2px 10px; border-radius: 5px 5px 5px 5px;" class="delete">حذف </button>
                        </p>
                    </div>
                </div>
            </div>
...
<div id="id01" class="modal ">
    ...
    <form   class="modal-content animate form-horizontal" action="Tile_save_edit.php" method="post" enctype="multipart/form-data">
        ...
        <div class="container">
            ...
            <div class="row col-sm-12" >
                <div class="form-group">
                    ...
                    <div class="col-md-4 selectContainer">
                        <div class="input-group">
                            <div id="wrapper" style="margin-top: 20px;"><input name="fileToUpload1" id="fileUpload1" multiple="multiple" type="file" />
            ...
            <div class="row col-sm-12">
                <div class="form-group">
                    ...
                    <div class="col-md-4 selectContainer">
                        <div class="input-group">
                            <div id="wrapper" style="margin-top: 20px;"><input name="fileToUpload2" id="fileUpload2" multiple="multiple" type="file" />
            ...
            <div class="row col-sm-12">
                <div class="form-group">
                    ...
                    <div class="col-md-4 selectContainer">
                        <div class="input-group">
                            <div id="wrapper" style="margin-top: 20px;"><input name="fileToUpload3" id="fileUpload3" multiple="multiple" type="file" />
            ...
            <input type="text" name="filter_size" id="filter_size" class="hidden" value="L"/>
            <input type="text" name="editimageinput" id="editimageinput" class="hidden" >
            <div  id="butdisplay"style="display: block;">
                <button type="button" onclick="showeditimage()" class="btn-success" style="float:left; margin-right: 5px; padding: 5px 15px 5px 15px;;" >ویرایش عکس ها</button>
            </div>
            <button type="submit" class="btn-success " style="float: left;padding: 5px 25px 5px 25px;" >ویرایش</button>
        </div>
    </form>
</div>
<div id="id02" class="modal ">
    <form   class="modal-content animate form-horizontal" action="Tile_save_delete.php" method="post" enctype="multipart/form-data" style="width: 40%">
        <div class="imgcontainer">
        ...
        <div class="container">
            <div class="form-group">
                <div class="col-md-9 selectContainer">
                    <div class="input-group">
                        <input type="text" name="name2" id="name2" style="border: none;border-radius: 5px 5px 5px 5px;text-align: center" disabled />
                    </div>
                </div>
                <label class="col-md-3 control-label"> تایید حذف محصول  با نام:  </label>
            </div>
            <input type="text" name="skudelete" id="skudelete" class="hidden" />
            <div class="form-group">
                <div class="col-md-9 selectContainer">
            <button type="submit" class="btn-warning" style="; padding: 5px 25px 5px 25px;margin-right: 20%;border-radius: 5px 5px 5px 5px;" >حذف</button>
                </div>
            </div>
        </div>
        <br/>
